...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-data.tree-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-data.tree-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-data.tree-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-data.tree-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-data.tree-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-data-tree-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-data.tree/badges/version.svg)](https://anaconda.org/conda-forge/r-data.tree)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-data.tree/badges/downloads.svg)](https://anaconda.org/conda-forge/r-data.tree)
